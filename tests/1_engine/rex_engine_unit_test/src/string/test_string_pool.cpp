...
TEST_CASE("TEST - StringPool - Find Or Store")
{
	...
	rex::StringPool string_pool;

	rex::StringID string_id1 = string_pool.find_or_store(string1);
	rex::StringID string_id11 = string_pool.find_or_store(string1);
	rex::StringID string_id2 = string_pool.find_or_store(string2);
