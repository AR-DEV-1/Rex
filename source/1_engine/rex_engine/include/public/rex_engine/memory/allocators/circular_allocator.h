...
{
	//
	// A circular allocator is an allocator that uses a single buffer in the backend and when reaching the end,
	// it wraps around and allocates again from the beginning
	//
	//   +-------------------------------------------------------------------------------------------------------------------------+
	//   |							  	 |																																																		 |
	//   |							     |                                                                                                     |
	...
	//
	//
	//	   +--------------------------------------------------------------------- will wrap around next allocation -------+
	//     |                                                                                                              |
	//     v                                                                                                              |
	//   +-------------------------------------------------------------------------------------------------------------------------+
	//   |							  	  																																														|				 |
