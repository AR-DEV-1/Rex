...
namespace rex
{
  ...
  namespace gfx
  {
    ...
    public:
      ...
      void reset(ScopedFencedAllocator&& alloc, ResourceStateTracker* resourceStateTracker, const ContextResetData& resetData);
    ...
    private:
      ScopedFencedAllocator m_allocator;  // The allocator to use for allocating gpu commands
