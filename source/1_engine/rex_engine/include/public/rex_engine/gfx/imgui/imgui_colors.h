...
namespace rex
{
	namespace imgui
	{
		...
		constexpr auto titlebar_orange			= IM_COL32(186, 66, 30, 255);
		constexpr auto titlebar_green				= IM_COL32(18, 88, 30, 255);
		constexpr auto titlebar_red					= IM_COL32(185, 30, 30, 255);
