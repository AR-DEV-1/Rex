  ...
  namespace gfx
  {
    namespace mesh_factory
    {
      StaticMesh create_box(f32 width, f32 height, f32 depth)
      {
        ...
        rsl::unique_ptr<VertexBuffer> vb = gfx::gal::instance()->create_vertex_buffer(v.size(), sizeof(v[0]), v.data());
        rsl::unique_ptr<IndexBuffer> ib = gfx::gal::instance()->create_index_buffer(i.size(), IndexBufferFormat::Uint16, i.data());
