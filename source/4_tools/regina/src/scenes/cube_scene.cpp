#include "regina/scenes/cube_scene.h"
...
namespace regina
{
  ...
  void CubeScene::build_geometry()
  {
...

    {
      ...
      m_cube_material = rex::gfx::material_lib::instance()->load_material(rex::vfs::instance()->abs_path(rex::MountingPoint::EngineMaterials, "default.material"));
